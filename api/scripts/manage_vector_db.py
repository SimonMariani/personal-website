...
def main():
    ...
    sync_parser.add_argument("--collection", default="documents", help="Target collection name.")
    ...
    search_parser.add_argument("--collection", default="documents", help="Collection to search.")
